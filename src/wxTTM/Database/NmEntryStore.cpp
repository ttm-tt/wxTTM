...
bool  NmEntryStore::CreateView()
{
  ...
  try
  {
    str = 
      ...
      "    plID, plNr, psLast, psFirst, naName, naDesc, naRegion, plExtID, ltID ) "
      "AS "
      "SELECT 1, nmSingle.nmNr, nm.nmID, nm.mtID, nm.tmID,       "
      "       lt.plID, lt.plNr, lt.psLast, lt.psFirst, lt.naName, lt.naDesc, lt.naRegion, lt.plExtID, lt.ltID "
    ...
    str = 
      ...
      "    nmType, nmNr, nmID, mtID, tmID,       "
      "    plAplID, plAplNr, plApsLast, plApsFirst, plAnaName, plAnaDesc, plAnaRegion, plAplExtID, plAltID, "
      "    plBplID, plBplNr, plBpsLast, plBpsFirst, plBnaName, plBnaDesc, plBnaRegion, plBplExtID, plBltID) "
      "AS "
      "SELECT 2, nmDouble.nmNr, nm.nmID, nm.mtID, nm.tmID, "
      "       ltA.plID, ltA.plNr, ltA.psLast, ltA.psFirst, ltA.naName, ltA.naDesc, ltA.naRegion, ltA.plExtID, ltA.ltID, "
      "       ltB.plID, ltB.plNr, ltB.psLast, ltB.psFirst, ltB.naName, ltB.naDesc, ltB.naRegion, ltB.plExtID, ltB.ltID  "
    ...
    str = 
      ...
      "    nmType, nmNr, nmID, mtID, tmID,                       "
      "    plAplID, plAplNr, plApsLast, plApsFirst, plAnaID, plAnaName,  plAnaDesc, plAnaRegion, plAplextID, ltAltID,  "
      "    plBplID, plBplNr, plBpsLast, plBpsFirst, plBnaID, plBnaName,  plBnaDesc, plBnaRegion, plBplextID, ltBltID ) "
      "AS "
      "SELECT 1, nmSingle.nmNr, nm.nmID, nm.mtID, nm.tmID,             "
      "       lt.plID, lt.plNr, lt.psLast, lt.psFirst, lt.naID, lt.naName, lt.naDesc, lt.naRegion, lt.plExtID, lt.ltID,  "
      ...
      "UNION "
      "SELECT 2, nmDouble.nmNr, nm.nmID, nm.mtID, nm.tmID,               "
      "       lta.plID, ltA.plNr, ltA.psLast, ltA.psFirst, ltA.naID, ltA.naName, ltA.naDesc, ltA.naRegion, ltA.plExtID, ltA.ltID,   "
      "       ltB.plID, ltB.plNr, ltB.psLast, ltB.psFirst, ltB.naID, ltB.naName, ltB.naDesc, ltB.naRegion, ltB.plExtID, ltB.ltID    "
