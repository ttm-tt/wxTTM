...
tmp->ExecuteUpdate(str = 
  ...
  "  SET @pts = 0 \n"
  "  SET @mpID = (SELECT mpID FROM MdRec WHERE mdID = @mdID) \n"
  "  \n"
  ...
  "   WHERE mtMatches > 1 AND mtMatchesA = mtMatchesX  \n"
  "  \n"
  "   --- Update pts if we have a specific table \n"
  "   IF (@mpID IS NOT NULL) \n"
  "   BEGIN \n"
  "     UPDATE @t SET mtMatchPoints = (SELECT mpPts FROM MpItem WHERE mpResA = mtMatchesA AND mpResX = mtMatchesX) \n"
  "      WHERE mtWalkOverA = 0 AND mtInjuredA = 0 AND mtDisqualifiedA = 0"
  "   END \n"
  "  RETURN  \n"
  "    \n"
  "END  \n"
...
tmp->ExecuteUpdate(str = 
  ...
  "  --- But skip all results with players who gave up or are byes \n"
  ...
  "            StAList.stDisqu = 0 AND StXList.stDisqu = 0 AND \n"
  "            StAList.tmID IS NOT NULL AND StXList.tmID IS NOT NULL \n"
  "     GROUP BY stA  \n"
...
tmp->ExecuteUpdate(str = 
  ...
  "          mtBallsA, mtBallsX, mtSetsA, mtSetsX, mtMatchesA, mtMatchesX,  \n"
  "            mtPointsA, mtPointsX, mtMatchCount, mtMatchPoints  \n"
  "      FROM dbo.IttfSortFunc(@grID, @ids)  \n"
  "  END  \n"
  ...
  "            mtBallsA, mtBallsX, mtSetsA, mtSetsX, mtMatchesA, mtMatchesX,   \n"
  "            mtPointsA, mtPointsX, mtMatchCount, mtMatchPoints  \n"
  "      FROM dbo.DttbSortFunc(@grID, @ids)  \n"
  "  END  \n"
    "  \n"
  "  RETURN  \n"
    "END  \n"
...
tmp->ExecuteUpdate(str = 
  ...
  "  mtMatchPoints " + SMALLINT + "  \n"
    ...
    "    RETURN  \n"
    "  \n"
  "  DECLARE @stID AS " + INTEGER + " \n"
  "  DECLARE @ids AS " + VARCHAR + "(200) \n"
  "  SET @ids = '' \n"
    "  DECLARE stIDCursor CURSOR FOR SELECT stID FROM StRec WHERE grID = @grID  \n"
    "  OPEN stIDCursor  \n"
    "  FETCH NEXT FROM stIDCursor INTO @stID  \n"
    "  WHILE (@@FETCH_STATUS = 0)  \n"
    "  BEGIN  \n"
    "    SET @ids = @ids + CAST(@stID AS " + VARCHAR + "(10)) + ','  \n"
    "    FETCH NEXT FROM stIDCursor INTO @stID  \n"
    "  END  \n"
  "  CLOSE stIDCursor \n"
  "  DEALLOCATE stIDCursor \n"
    "  \n"
  "  INSERT INTO @t (grID, stID, stPos,   \n"
  "            mtBallsA, mtBallsX, mtSetsA, mtSetsX, mtMatchesA, mtMatchesX,   \n"
  "            mtPointsA, mtPointsX, mtMatchCount, mtMatchPoints)   \n"
  ...
  "            mtBallsA, mtBallsX, mtSetsA, mtSetsX, mtMatchesA, mtMatchesX,  \n"
  "            mtPointsA, mtPointsX, mtMatchCount, mtMatchPoints  \n"
  "      FROM dbo.TbSortSubsetFunc(@grID, @ids)  \n"
  "  \n"
  "  RETURN  \n"
    "END  \n"
);
