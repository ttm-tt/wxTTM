...
bool  MtEntryStore::CreateView()
{
  ...
  try
  {
    str = "CREATE VIEW MtSingleList                                             "
          ...
          "  plAplNr, plApsLast, plApsFirst, plAnaID, plAnaName, plAnaDesc, plAnaRegion, plAplExtID,  "
          "  stA, tmAtmID, tmAnaID,                                             "
          "  plXplNr, plXpsLast, plXpsFirst, plXnaID, plXnaName, plXnaDesc, plXnaRegion, plXplExtID,  "
          "  stX, tmXtmID, tmXnaID,                                             "
          ...
          "          sta.plNr, sta.psLast, sta.psFirst, sta.naID, sta.naName, sta.naDesc, sta.naRegion, sta.plExtID, "
          "          mt.stA, sta.tmID, sta.tmnaID,                              "
          "          stx.plNr, stx.psLast, stx.psFirst, stx.naID, stx.naName, stx.naDesc, stx.naRegion, stx.plExtID, "
    ...
    str = "CREATE VIEW MtDoubleList                             "
          ...
          "  mtInjuredA, mtInjuredX, mtDisqualifiedA, mtDisqualifiedX,          "
          "  plAplNr, plApsLast, plApsFirst, plAnaID, plAnaName, plAnaDesc, plAnaRegion, plAplExtID, "
          "  plBplNr, plBpsLast, plBpsFirst, plBnaID, plBnaName, plBnaDesc, plBnaRegion, plBplExtID, "
          "  stA, tmAtmID, tmAnaID,                             "
          "  plXplNr, plXpsLast, plXpsFirst, plXnaID, plXnaName, plXnaDesc, plXnaRegion, plXplExtID, "
          "  plYplNr, plYpsLast, plYpsFirst, plYnaID, plYnaName, plYnaDesc, plYnaRegion, plYplExtID, "
          "  stX, tmXtmID, tmXnaID,                             "
