...
bool  StEntryStore::CreateView()
{
  ...
  try
  {
    str = "CREATE VIEW StSingleList (                                         "
          ...
          " stTimestamp, "
          " plNr, psLast, psFirst, naID, naName, naDesc, naRegion, plExtID, tmID, tmnaID)     "
          "AS                                                                 "
          "  SELECT stID, grID, stNr, stPos, stSeeded, stGaveup, stDisqu,     "
          "         stNocons, stTimestamp, "
          "         plNr, psLast, psFirst, tm.naID, naName, naDesc, naRegion, plExtID, st.tmID, tm.tmnaID   "
    ...
    str = "CREATE VIEW StDoubleList (                                         "
          "  stID, grID, stNr, stPos, stSeeded, stGaveup, stDisqu, stNocons,  "
          "  stTimestamp, "
          "  plplNr, plpsLast, plpsFirst, plnaID, plnaName, plnaDesc, plnaRegion, plplExtID,      "
          "  bdplNr, bdpsLast, bdpsFirst, bdnaID, bdnaName, bdnaDesc, bdnaRegion, bdplExtID,      "
          "  tmID, tmnaID)                                                    "
          "AS                                                                 "
          "  SELECT stID, grID, stNr, stPos, stSeeded, stGaveup, stDisqu,     "
          "         stNocons, stTimestamp, "
          "         plplNr, plpsLast, plpsFirst, tm.plnaID, plnaName, plnaDesc, plnaRegion, plplExtID, "
          "         bdplNr, bdpsLast, bdpsFirst, tm.bdnaID, bdnaName, bdnaDesc, bdnaRegion, bdplExtID, "
          "         st.tmID, tm.tmnaID  "
    ...
    str = "CREATE VIEW StTeamList (                                           "
          ...
          "  SELECT stID, grID, stNr, stPos, stSeeded, stGaveup, stDisqu,     "
          "         stNocons, stTimestamp, "
          "         tmName, tmDesc, naName, naDesc, naRegion, st.tmID, tm.tmnaId        "
