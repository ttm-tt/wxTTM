...
bool  MtStore::ExportForRanking(const wxString &name, short cpType, const std::vector<long> &idList, bool append)
{
  ...
  if (!append)
  {
    ...
    os << "# Scheduled;Match No;Event;Group;Stage;Round;Match;Indiv. Match;"
          "Pl. A ID;Pl. A Family Name;Pl. A Given Name;Pl. A Association;"
          "Pl. B ID;Pl. B Family Name;Pl. B Given Name;Pl. B Association;"
          "Pl. X ID;Pl. X Family Name;Pl. X Given Name;Pl. X Association;"
          "Pl. Y ID;Pl. Y Family Name;Pl. Y Given Name;Pl. Y Association;"
          "Best Of;"
  ...
  for (std::vector<long>::const_iterator it = idList.begin(); it != idList.end(); it++)
  {
    ...
    if (cpType == CP_SINGLE)
      str = 
        ...
        "plAplExtID, plApsLast, plApsFirst, plAnaName, "
        "NULL AS plBplExtId, NULL AS plBpsLast, NULL AS plBpsFirst, NULL AS plBnaName, "
        "plXplExtID,  plXpsLast, plXpsFirst, plXnaName, "
        "NULL AS plYplExtId, NULL AS plYpsLast, NULL AS plYpsFirst, NULL AS plYnaName, "
        "mtBestOf, "
      ...
      str = 
        ...
        "mtDateTime, mtNr, cpName, grName, grStage, mtRound, mtMatch, NULL AS mtMS, "
        "plAplExtID, plApsLast, plApsFirst, plAnaName, "
        "plBplExtId, plBpsLast, plBpsFirst, plBnaName, "
        "plXplExtID, plXpsLast, plXpsFirst, plXnaName, "
        "plYplExtId, plYpsLast, plYpsFirst, plYnaName, "
        "mtBestOf, "
        "mtSet1.mtResA, mtSet1.mtResX, mtSet2.mtResA, mtSet2.mtResX, mtSet3.mtResA, mtSet3.mtResX, "
        "mtSet4.mtResA, mtSet4.mtResX, mtSet5.mtResA, mtSet5.mtResX, mtSet6.mtResA, mtSet6.mtResX, mtSet7.mtResA, mtSet7.mtResX, "
